...
Camvgo.com is committed to protecting your privacy. We have developed this Privacy Policy so that you may easily understand the way in which we protect your user data we collect from you and other related information.

This Privacy Policy applies to Camvgo.com which is referred to in this Privacy Policy as “we,” “us,” “our” or Camvgo.” Camvgo provides engaging content for its users, including quizzes, personality tests, and casual games.

The Privacy Policy is available to the public at all times so you may read the full text of the Privacy Policy on Camvgo’s website whenever you need or want to do so. Camvgo will notify you of any changes to the Privacy Policy by posting an amended version or amendments to its website to notify you of changes.

INFORMATION WE RECEIVE AND/OR COLLECT

1. We collect information from a number of sources. First, users can log into Camvgo website using authentication services of third parties.

If you use your Facebook user name and password to log into our website, we receive the following types of information about you from Facebook:

Your Facebook user name.
The gender designation you provided Facebook.
Your Facebook profile picture.
2. Second, we receive and/or collect other types of data and information about users when they use our website. For instance, we receive users’ input in response to quiz or personality test questions. We make no attempt to link your quiz answers or personality test choices or results to individual identities.

3. Third, we receive your Facebook app-scoped ID. The app-scoped ID is a unique identifier for a user, which is unique to a given application. Thus, the app-scoped ID we receive is only used for Camvgo, and we cannot identify our user’s Facebook user ID (Facebook-assigned unique identifier), with this app-scoped ID. Facebook does not share with us the link between an app-scoped ID and a Facebook user ID.

4. Except for the information described above, we do not receive any other information from social networks used for login purposes. In accordance with social media service features, we may show the information that social media service provider directly provide to your device. However we do not receive or store that information.

COLLECTION OF INFORMATION BY COOKIES

1. In order to provide you with customized services, we may uses cookies, which are saved on your personal computer (“PC”) and retrieved whenever required for any PC-based services. Cookies are small text files of information sent to your browser by the website operating server, which are then stored on the hard drive of your PC. When you visit a website, cookies are accessed by the server to ensure that your preferences are maintained, which helps you view and use our website’s content more efficiently. Moreover, cookies tell us how often your visit the website, how you use the website and what information interests you. In this way, we can provide content and services optimized for your needs.

You have an option to enable or disable cookies. You may configure your browser to accept all cookies, get an alert before accepting cookies, or disable all cookies. Please bear in mind that you will not be able to access some of the content or services requiring a login process if you disable cookies.
...
Our Website may contain links to or features from other websites. This Privacy Policy covers our privacy practices and does not cover the privacy practices of third party websites or features. We are not responsible for the privacy policies and/or practices of third parties. When linking to another website or using a third party service, any information you provide is subject to that third party site’s Privacy Policy, and we encourage you to review that website’s Privacy Policy before providing any personally identifiable information.

PROTECTION OF INFORMATION

We will take reasonable measures to ensure that user data we collect, use, disclose, or otherwise process is protected and not used or disclosed for purposes other than as directed by Camvgo. In specific, Camvgo is committed to maintaining reasonable and appropriate administrative, physical, and technical safeguards to:
